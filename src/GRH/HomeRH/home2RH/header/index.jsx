    ...
    <>
      <div className="header">
        <div className="container">
          ...
          >
            <Link to="/dream-pos/Dashboard-rh" className="logo logo-normal">
              <img src={Logo} alt="" />
            </Link>
            <Link to="/dream-pos/Dashboard-rh" className="logo logo-white">
              <img src={LogoWhite} alt="" />
            </Link>
            <Link to="/dream-pos/Dashboard-rh" className="logo-small">
