...
const Dcomplement = ({ onRequestSubmitted }) => {
  const [formData, setFormData] = useState({
    typegrh: 'CS', // Specify the type as "CS"
    codetiers: '',
    datedeb: '',
    datefin: '',
    obj: '', // This field could be omitted if not used
      ...
      <div className="content">
        <div className="page-header">
          <div className="page-title">
            <h4>Demande de complement</h4>
            <h6>Create a new demande de complement</h6>
          </div>
        </div>
